...
import { X, Lock, Check, Info, Settings, GamepadIcon } from "lucide-react"
          ...
          >
            ...
            >
              ...
              <div className="w-14 h-14 rounded-full flex items-center justify-center relative">
                ...
                {/* Inner button */}
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-cyan-900/80 to-blue-900/80 flex items-center justify-center z-10 shadow-inner">
              ...
              {/* Tooltip */}
              <div className="absolute -top-10 left-1/2 transform -translate-x-1/2 bg-black/80 text-cyan-400 text-xs py-1 px-2 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap border border-cyan-500/30">
                Arcade Games
              </div>
            </motion.button>
          </motion.div>
